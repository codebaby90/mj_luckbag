...
$link = array(
    ...
    'home'  => 'http://www.mojiruwo.top?ref=install',
    'forum' => 'http://forum.mojiruwo.top?ref=install',
    'doc'   => 'http://doc.mojiruwo.top?ref=install',
);
...
{
    $errInfo = '当前权限不足，无法写入配置文件application/database.php<br><a href="http://forum.mojiruwo.top/?q=%E6%9D%83%E9%99%90%E4%B8%8D%E8%B6%B3" target="_blank">点击查看解决办法</a>';
}
else
{
    $dirArr = [];
    foreach ($checkDirs as $k => $v)
    {
        ...
        {
            $errInfo = '当前代码仅包含核心代码，请前往官网下载完整包或资源包覆盖后再尝试安装，<a href="http://www.mojiruwo.top/download.html?ref=install" target="_blank">立即前往下载</a>';
            break;
        }
    }
}
