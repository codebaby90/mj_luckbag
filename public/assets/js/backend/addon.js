            ...
            table.on('click', '.btn-addoninfo', function (event) {
                ...
                Layer.alert(Template("addoninfotpl", {item: item, addon: addon}), {
                    ...
                    success: function (layero, index) {
                        $(".layui-layer-btn2", layero).attr("href", "http://forum.mojiruwo.top/t/bug?ref=addon&name=" + item.name).attr("target", "_blank");
                        $(".layui-layer-btn3", layero).attr("href", "http://www.mojiruwo.top/store/" + item.name + ".html?ref=addon").attr("target", "_blank");
                    }
                });
            });
            ...
            $(document).on("click", ".btn-userinfo", function () {
                ...
                if (!userinfo) {
                    Layer.open({
                        ...
                        success: function (layero, index) {
                            $(".layui-layer-btn1", layero).prop("href", "http://www.mojiruwo.top/user/register.html").prop("target", "_blank");
                        }
                    });
                } else {
                    var userinfo = Controller.api.userinfo.get();
