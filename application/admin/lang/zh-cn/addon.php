...
return [
    ...
    'Online store'                   => '在线商店',
    'Local addon'                    => '本地插件',
    'Https tips'                     => '当前你无法在插件管理中在线安装FastAdmin市场中的插件，请前往 <a href="http://www.mojiruwo.top/store.html" target="_blank" class="">FastAdmin插件市场</a> 中下载后进行离线安装。',
    'Conflict tips'                  => '此插件中发现和现有系统中部分文件发现冲突！以下文件将会被影响，请备份好相关文件后再继续操作',
    'Login tips'                     => '此处登录账号为<a href="http://www.mojiruwo.top" target="_blank">FastAdmin官网账号</a>',
