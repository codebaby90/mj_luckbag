...
return [
    ...
    'If not necessary, use the command line to build rule'      => '非必要情况下请直接使用命令行<a href="http://doc.mojiruwo.top/docs/command.html#一键生成菜单" target="_blank">php think menu</a>来生成',
