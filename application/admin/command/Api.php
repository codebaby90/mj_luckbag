        ...
        if (version_compare(PHP_VERSION, '7.0.0', '<')) {
            if (extension_loaded('opcache')) {
                ...
                if (!$directives[$configName]) {
                    throw new Exception("Please make sure {$configName} is turned on, Get help:http://forum.mojiruwo.top/d/1321");
                }
            } else {
                throw new Exception("Please make sure opcache already enabled, Get help:http://forum.mojiruwo.top/d/1321");
            }
        }
